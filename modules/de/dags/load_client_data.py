...
customer_profiles_task = PythonOperator(
    ...
    op_kwargs={"file_name": "customer_profiles.csv", "table_name": "customer_profiles"},
    dag=dag,
)
...
customer_activity_task = PythonOperator(
    ...
    python_callable=load_data_from_s3_to_postgres,
    op_kwargs={"file_name": "customer_activity.csv", "table_name": "customer_activity"},
    dag=dag,
)
...
labels_task = PythonOperator(
    task_id="load_labels",
    python_callable=load_data_from_s3_to_postgres,
    op_kwargs={"file_name": "labels.csv", "table_name": "labels"},
    dag=dag,
)
...
stores_task = PythonOperator(
    task_id="load_stores",
    python_callable=load_data_from_s3_to_postgres,
    op_kwargs={"file_name": "stores.csv", "table_name": "stores"},
    dag=dag,
)
...
[
    customer_profiles_task,
    customer_activity_task,
    labels_task,
    stores_task,
] >> trigger_process_data
